...
<div class="row mt-3">
    <div class="col-sm-12 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/poco/sim_online.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm-12 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/poco/sim_off2on.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div style="background-color: #f8f9fa; padding: 1rem;">
  <div class="row justify-content-center">
    <div class="col-sm-6 mt-3 mt-md-0 text-center">
        ...
        <div class="caption" style="font-size:1.2rem; margin-top:0.5rem; margin-bottom:0;">
            Pick Cube
        </div>
    </div>
    <div class="col-sm-6 mt-3 mt-md-0 text-center">
