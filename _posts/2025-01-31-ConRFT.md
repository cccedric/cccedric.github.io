...
* [👉 Read the article (in Chinese)](https://www.jiqizhixin.com/articles/2025-04-18?from=synced&keyword=conrft)

**Shenlan AI (深蓝AI)**
* Our work was also covered by Shenlan AI (深蓝AI), a leading Chinese AI education and research platform.  
* [👉 Read the article (in Chinese)]([这里放深蓝学院的链接](https://mp.weixin.qq.com/s/RBL8PkmzrT2go90J9bF9bw))

## Introduction Video
<div class="row mt-3">
    <div class="col-sm d-flex justify-content-center mt-3 mt-md-0">
        {% include video.liquid path="https://www.youtube.com/embed/ApnHd8jUd2Q" class="rounded z-depth-1" width="800" height="450" %}
    </div>
</div>
    ...
    <div class="col">
      <div class="row mt-3">
        <div class="col-sm mt-3 mt-md-0 text-center">
          {% include video.liquid path="assets/video/conRFT/task1/task1_disturb.mp4"
             class="img-fluid rounded z-depth-1" controls=true autoplay=true %}
        </div>
        <div class="col-sm mt-3 mt-md-0 text-center">
          {% include video.liquid path="assets/video/conRFT/task9/task9_disturb.mp4"
             class="img-fluid rounded z-depth-1" controls=true autoplay=true %}
        </div>
      </div>
    </div>
...
{% tabs citation_conrft %}
{% tab citation_conrft Arxiv Version%}
...
{% tab citation_conrft RSS25 Version%}
Or, for citing our work presented at the RSS 2025:
